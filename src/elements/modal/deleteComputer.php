...
<div class="modal fade" id="<?= " deleteComputerModal_" . htmlspecialchars($computer->id_postes); ?>" tabindex="-1"
    aria-labelledby="deleteComputerModalLabel" aria-hidden="true">
