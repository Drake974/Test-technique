...
<div class="form-floating  mb-4 mt-3">
  <input type="date" class="form-control form-date" id="floatingHome" placeholder="00/00/0000" name="search_date" required>
...
<table class="table table-striped">
  ...
  <?php if(isset($_POST["home_date_choose"]) or isset($_POST["show_register"])):?>
    ...
    <tr>
      ...
      <td scope="row" class="text-center"><?= htmlspecialchars($user->horaire); ?> </td>
      
      
      <td  class="text-center"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-laptop-fill text-danger" viewBox="0 0 16 16" >
  <path d="M2.5 2A1.5 1.5 0 0 0 1 3.5V12h14V3.5A1.5 1.5 0 0 0 13.5 2h-11zM0 12.5h16a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 12.5z"/>
</svg> </div>n° <?= htmlspecialchars($user->numero_poste); ?></td>
      <td scope="row" class="text-center"><?= htmlspecialchars($user->numero_utilisateur); ?> </td>    
